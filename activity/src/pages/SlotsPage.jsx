        ...
        <div style={{ background: '#1a2c38', borderRadius: isMobile ? 20 : 24, padding: isMobile ? 16 : 20, border: '1px solid rgba(255,255,255,0.06)', boxShadow: '0 18px 40px rgba(0,0,0,0.18)', minWidth: 0, order: isMobile ? 2 : 1 }}>
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
              ...
              />
              <button onClick={() => modifyBet(0.5)} disabled={busy} style={{ ...actionBtn, padding: '0 16px', fontSize: 15 }}>
                1/2
              </button>
              <button onClick={() => modifyBet(2)} disabled={busy} style={{ ...actionBtn, padding: '0 16px', fontSize: 15 }}>
                2x
              </button>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 6 }}>
              ...
              <button onClick={() => setFractionBet(0.75)} disabled={busy} style={actionBtn}>3/4</button>
