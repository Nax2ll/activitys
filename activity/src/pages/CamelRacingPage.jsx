...
const CAMEL_COLORS = [
  { id: 1, color: '#ff4d4d', name: 'Red Runner' },
  { id: 2, color: '#3b82f6', name: 'Blue Bolt' },
  { id: 3, color: '#10b981', name: 'Green Ghost' },
  { id: 4, color: '#f59e0b', name: 'Yellow Yonder' },
  { id: 5, color: '#8b5cf6', name: 'Purple Pride' }
];
